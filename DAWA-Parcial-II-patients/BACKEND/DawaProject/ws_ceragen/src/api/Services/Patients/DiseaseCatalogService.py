...
class DiseaseCatalogInsertService(Resource):
    ...
    def post():
        try:
            ...
            HandleLogs.write_error(f"[InsertDiseaseCatalog][POST] {str(e)}")
...
class DiseaseCatalogUpdateService(Resource):
    ...
    def patch(dis_id):
        try:
            ...
            HandleLogs.write_error(f"[UpdateDiseaseCatalog][PATCH] {str(e)}")
            return response_error("Error en el servicio")
...
class DiseaseCatalogDeleteService(Resource):
    ...
    def delete(dis_id):
        try:
            ...
            HandleLogs.write_error(f"[DeleteDiseaseCatalog][DELETE] {str(e)}")
...
class DiseaseCatalogListService(Resource):
    ...
    def get():
        try:
            ...
            HandleLogs.write_error(f"[ListDiseaseCatalog][GET] {str(e)}")
            return response_error("Error en el servicio")
